...
namespace EventBus.AzureServiceBus
{
    public class EventBusServiceBus : BaseEventBus
    {
        ...
        private ITopicClient CreateTopicClient()
        {
            ...
            //Topic var mı diye kontrol ediyor.
        ...
        public override void Publish(IntegrationEvent @event)
        {
            ...
            eventName = ProcessEventName(eventName); // example : after trim OrderCreated
        ...
        public override void Subscribe<T, TH>()
        {
            ...
            {
                var subscriptionClient = CreateSubsciptionClientIfNotExists(eventName);
        ...
        private ISubscriptionClient CreateSubsciptionClientIfNotExists(string eventName)
        {
